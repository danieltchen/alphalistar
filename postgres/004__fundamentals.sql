...
-- Alter FUNDAMENTALS table to add new fundamentals and remove redundant sector, industry, country
ALTER TABLE FUNDAMENTALS DROP COLUMN IF EXISTS sector;
ALTER TABLE FUNDAMENTALS DROP COLUMN IF EXISTS industry;
ALTER TABLE FUNDAMENTALS DROP COLUMN IF EXISTS country; 

ALTER TABLE FUNDAMENTALS
ADD COLUMN enterpriseValue BIGINT,
ADD COLUMN priceToBook DECIMAL(15,6),
ADD COLUMN trailingPegRatio DECIMAL(15,6),
ADD COLUMN priceToSalesTrailing12Months DECIMAL(15,6),

-- Dividend metrics
ADD COLUMN dividendRate DECIMAL(15,6),
ADD COLUMN payoutRatio DECIMAL(15,6),
ADD COLUMN fiveYearAvgDividendYield DECIMAL(15,6),

-- Risk and trading metrics
ADD COLUMN beta DECIMAL(15,6),
ADD COLUMN volume BIGINT,
ADD COLUMN regularMarketVolume BIGINT,
ADD COLUMN averageVolume BIGINT,

-- Price ranges and averages
ADD COLUMN fiftyTwoWeekLow DECIMAL(15,4),
ADD COLUMN fiftyTwoWeekHigh DECIMAL(15,4),
ADD COLUMN fiftyTwoWeekRange VARCHAR(50),
ADD COLUMN fiftyTwoWeekChangePercent DECIMAL(15,6),
ADD COLUMN fiftyTwoWeekLowChange DECIMAL(15,4),
ADD COLUMN fiftyTwoWeekLowChangePercent DECIMAL(15,6),
ADD COLUMN fiftyTwoWeekHighChange DECIMAL(15,4),
ADD COLUMN fiftyTwoWeekHighChangePercent DECIMAL(15,6),
ADD COLUMN fiftyDayAverage DECIMAL(15,4),
ADD COLUMN fiftyDayAverageChange DECIMAL(15,4),
ADD COLUMN fiftyDayAverageChangePercent DECIMAL(15,6),
ADD COLUMN twoHundredDayAverage DECIMAL(15,4),
ADD COLUMN twoHundredDayAverageChange DECIMAL(15,4),
ADD COLUMN twoHundredDayAverageChangePercent DECIMAL(15,6),

-- Share metrics
ADD COLUMN floatShares BIGINT,
ADD COLUMN sharesOutstanding BIGINT,
ADD COLUMN sharesShort BIGINT,
ADD COLUMN bookValue DECIMAL(15,4),

-- Earnings metrics
ADD COLUMN trailingEps DECIMAL(15,6),
ADD COLUMN forwardEps DECIMAL(15,6),
ADD COLUMN epsForward DECIMAL(15,6),
ADD COLUMN earningsQuarterlyGrowth DECIMAL(15,6),
ADD COLUMN earningsGrowth DECIMAL(15,6),

-- Enterprise and revenue metrics
ADD COLUMN enterpriseToRevenue DECIMAL(15,6),
ADD COLUMN enterpriseToEbitda DECIMAL(15,6),
ADD COLUMN totalRevenue BIGINT,
ADD COLUMN revenueGrowth DECIMAL(15,6),
ADD COLUMN revenuePerShare DECIMAL(15,6),

-- Cash and debt metrics
ADD COLUMN totalCash BIGINT,
ADD COLUMN totalCashPerShare DECIMAL(15,6),
ADD COLUMN ebitda BIGINT,
ADD COLUMN totalDebt BIGINT,
ADD COLUMN netIncomeToCommon BIGINT,
ADD COLUMN debtToEquity DECIMAL(15,6),

-- Liquidity ratios
ADD COLUMN quickRatio DECIMAL(15,6),
ADD COLUMN currentRatio DECIMAL(15,6),

-- Profitability metrics
ADD COLUMN returnOnAssets DECIMAL(15,6),
ADD COLUMN returnOnEquity DECIMAL(15,6),
ADD COLUMN profitMargins DECIMAL(15,6),
ADD COLUMN grossMargins DECIMAL(15,6),
ADD COLUMN ebitdaMargins DECIMAL(15,6),
ADD COLUMN operatingMargins DECIMAL(15,6),
ADD COLUMN grossProfits BIGINT,

-- Cash flow metrics
ADD COLUMN freeCashflow BIGINT,
ADD COLUMN operatingCashflow BIGINT,

-- Analyst and target metrics
ADD COLUMN averageAnalystRating VARCHAR(50),
ADD COLUMN recommendationMean DECIMAL(15,6),
ADD COLUMN recommendationKey VARCHAR(50),
ADD COLUMN numberOfAnalystOpinions INTEGER,
ADD COLUMN targetHighPrice DECIMAL(15,4),
ADD COLUMN targetLowPrice DECIMAL(15,4),
ADD COLUMN targetMeanPrice DECIMAL(15,6),
ADD COLUMN targetMedianPrice DECIMAL(15,6);
...
COMMENT ON COLUMN FUNDAMENTALS.fullTimeEmployees IS 'Total number of full-time employees at the company';
